...
PAGES = [
    dict(slug='index',    file='page_index.html',    title='Кафе «КОЛОБОК» в Удомле — шаурма, кура-гриль, выпечка с доставкой',
         desc='Кафе «Колобок», Удомля, ул. Космонавтов, 1а. Шаурма на гриле, кура-гриль, бургеры, выпечка. Заказ онлайн, оплата картой, доставка по городу за 30–45 минут. Тел. +7 (900) 473-20-35'),
    ...
    dict(slug='delivery', file='page_delivery.html', title='Доставка и оплата — «КОЛОБОК» Удомля',
         desc='Доставка по Удомле за 30–45 минут, бесплатно от 700 ₽. Оплата картой, СБП или при получении. Заказ уходит администратору на +7 (900) 473-20-35.'),
    ...
    dict(slug='checkout', file='page_checkout.html', title='Оформление заказа — «КОЛОБОК» Удомля',
         desc='Оформите заказ в кафе «Колобок»: доставка или самовывоз, оплата картой онлайн, СБП или при получении.'),
]
